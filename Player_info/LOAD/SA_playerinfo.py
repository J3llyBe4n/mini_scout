...
# team_id 받아오기
getTeamApiIdNameSql = 'SELECT DISTINCT hidden_team_id.api_team_id, hidden_team_id.team_name FROM team_info  JOIN hidden_team_id ON team_info.team_name = hidden_team_id.team_name  WHERE team_info.league_id = 33 AND team_info.season_id = %d' %insertSeasonId
